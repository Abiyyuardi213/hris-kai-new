...
@section('content')
    <div class="flex flex-col space-y-6">
        ...
        <div class="flex items-center justify-between">
            <h2 class="text-3xl font-bold tracking-tight">Edit Kota</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="province_code" id="province_code"
                                value="{{ old('province_code', $city->province_code) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="province_name" id="province_name"
                                value="{{ old('province_name', $city->province_name) }}" required
