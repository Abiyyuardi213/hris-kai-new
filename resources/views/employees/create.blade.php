                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="jabatan_id" id="jabatan_id"
                                ...
                                @foreach ($positions as $pos)
                                    <option value="{{ $pos->id }}"
                                        {{ old('jabatan_id') == $pos->id ? 'selected' : '' }}>{{ $pos->name }}</option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <select name="kantor_id" id="kantor_id"
                                ...
                                @foreach ($offices as $office)
                                    <option value="{{ $office->id }}"
                                        {{ old('kantor_id') == $office->id ? 'selected' : '' }}>{{ $office->office_name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-zinc-500">Pilih akun pengguna agar pegawai bisa login.</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        <div class="h-16 w-16 overflow-hidden rounded-full bg-zinc-100 border border-zinc-200">
                            <!-- Placeholder script handled preview likely needed but keeping simple -->
                            <i data-lucide="user" class="h-full w-full p-3 text-zinc-300 block"></i>
                        </div>
                        <div class="flex-1 max-w-sm">
                            <label for="foto" class="block text-sm font-medium text-zinc-900">Upload Foto</label>
