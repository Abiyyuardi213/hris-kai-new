    ...
    <div class="flex flex-col space-y-6">
            ...
            <div
                ...
                <div class="p-8 flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div
                        ...
                        <p class="text-5xl font-bold tracking-tight">{{ $appraisal->rating }}</p>
                    </div>
                    ...
                    <div class="flex-1 min-w-0 text-center md:text-left">
                        <div class="flex items-center justify-center md:justify-start gap-2 mb-2">
                            ...
                            <span class="text-xs text-zinc-400 font-medium">{{ $appraisal->periode_mulai->format('M Y') }}
                                - {{ $appraisal->periode_selesai->format('M Y') }}</span>
                        </div>
                        <h3 class="text-2xl font-bold text-zinc-900 uppercase tracking-tight mb-2">Penilaian
                            Kinerja Tahunan</h3>
                    ...
                    <div
                        ...
                        <div class="text-right">
                            <p
                                class="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-1 text-center md:text-right">
                                Final Score</p>
                            <p class="text-3xl font-bold text-zinc-900 tracking-tight text-center md:text-right">
        ...
        @empty
            <div class="bg-white rounded-3xl border border-zinc-100 p-20 text-center">
                ...
                <h3 class="text-xl font-bold text-zinc-900 uppercase tracking-tight">Belum Ada Riwayat Penilaian
                </h3>
