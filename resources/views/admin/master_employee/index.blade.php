        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl border border-zinc-200 shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-zinc-100 flex items-center justify-between">
                    ...
                    <a href="{{ route('mutations.index') }}" class="text-xs font-bold text-blue-600 hover:underline">Lihat
                        Semua</a>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-zinc-100">
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="px-6 py-8 text-center text-zinc-500">Belum ada data mutasi.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
                    ...
                    @forelse($upcomingHolidays as $holiday)
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-zinc-500">{{ \Carbon\Carbon::parse($holiday->date)->format('l') }}
                                </p>
                            </div>
                        </div>
                    @empty
