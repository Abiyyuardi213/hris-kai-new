...
@section('content')
    <div class="flex flex-col space-y-6">
        ...
        <div class="flex items-center justify-between">
            <h2 class="text-3xl font-bold tracking-tight">Tambah Agenda</h2>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="type" id="type" required
                                ...
                                <option value="event" {{ old('type') == 'event' ? 'selected' : '' }}>Event / Acara</option>
                                <option value="meeting" {{ old('type') == 'meeting' ? 'selected' : '' }}>Meeting / Rapat
                                </option>
                                <option value="holiday" {{ old('type') == 'holiday' ? 'selected' : '' }}>Hari Libur
                                </option>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="mt-1 block w-full rounded-lg border border-zinc-300 px-3 py-2 text-sm focus:border-zinc-900 focus:outline-none focus:ring-1 focus:ring-zinc-900"
                            placeholder="Detail agenda...">{{ old('description') }}</textarea>
                    </div>
