    ...
    <div class="flex-1 overflow-y-auto px-4 py-8 space-y-8 scrollbar-hide">
        ...
        <div class="space-y-1.5">
            ...
            <a href="{{ route('employee.mutations.index') }}"
                class="flex items-center gap-3 rounded-2xl px-4 py-3.5 text-sm transition-all {{ Request::is('mutations*') ? 'bg-zinc-900 text-white shadow-xl shadow-zinc-200' : 'text-zinc-500 hover:bg-zinc-50 hover:text-zinc-900' }}">
                <i data-lucide="trending-up" class="h-5 w-5"></i>
                <span class="font-bold">Riwayat Mutasi</span>
            </a>
            <a href="{{ route('employee.sanctions.index') }}"
                class="flex items-center gap-3 rounded-2xl px-4 py-3.5 text-sm transition-all {{ Request::is('sanctions*') ? 'bg-zinc-900 text-white shadow-xl shadow-zinc-200' : 'text-zinc-500 hover:bg-zinc-50 hover:text-zinc-900' }}">
                <i data-lucide="alert-triangle" class="h-5 w-5"></i>
                <span class="font-bold">Sanksi Disiplin</span>
            </a>
            ...
            <a href="{{ route('employee.project-payroll.index') }}"
                class="flex items-center gap-3 rounded-2xl px-4 py-3.5 text-sm transition-all {{ Request::is('project-payroll*') ? 'bg-zinc-900 text-white shadow-xl shadow-zinc-200' : 'text-zinc-500 hover:bg-zinc-50 hover:text-zinc-900' }}">
