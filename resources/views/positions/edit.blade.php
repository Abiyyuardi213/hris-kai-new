...
@section('content')
    <div class="flex flex-col space-y-6">
        ...
        <div class="rounded-xl border bg-white shadow-sm p-6 max-w-2xl">
            <form
                action="{{ route('positions.update', ['position' => $position->id] + request()->only('page', 'sort', 'search')) }}"
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <input type="number" id="tunjangan" name="tunjangan"
                                    value="{{ old('tunjangan', $position->tunjangan) }}" required
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <input type="number" id="tunjangan_perumahan" name="tunjangan_perumahan"
                                    value="{{ old('tunjangan_perumahan', $position->tunjangan_perumahan) }}" required
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <input type="number" id="tunjangan_pajak" name="tunjangan_pajak"
                                    value="{{ old('tunjangan_pajak', $position->tunjangan_pajak) }}" required
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <input type="number" id="potongan_mandiri_inhealth" name="potongan_mandiri_inhealth"
                                    value="{{ old('potongan_mandiri_inhealth', $position->potongan_mandiri_inhealth) }}" required
