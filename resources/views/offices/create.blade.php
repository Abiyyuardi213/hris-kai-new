...
@section('content')
    <div class="flex flex-col space-y-6">
        ...
        <div class="flex items-center justify-between">
            <h2 class="text-3xl font-bold tracking-tight">Tambah Kantor</h2>
        ...
        <div class="rounded-xl border bg-white shadow-sm p-6 max-w-2xl">
            <form action="{{ route('offices.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="office_address" id="office_address" rows="3" required
                            ...
                            placeholder="Alamat lengkap kantor...">{{ old('office_address') }}</textarea>
