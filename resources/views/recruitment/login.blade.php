...
<head>
    ...
    <title>Login Rekrutmen - PT KAI</title>
...
<body class="bg-zinc-50 min-h-screen flex items-center justify-center p-6">
    <div class="w-full max-w-[420px] space-y-8">
        ...
        <div class="flex flex-col items-center">
            ...
            <h1 class="text-2xl font-bold tracking-tight text-zinc-900">Portal Rekrutmen</h1>
            <p class="text-sm text-zinc-500 mt-2 text-center">Rekrutmen Calon Pegawai PT Kereta Api Indonesia
                (Persero)</p>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-zinc-200 shadow-sm overflow-hidden">
            <div class="p-8">
                <form action="{{ route('candidate.login.submit') }}" method="POST" class="space-y-6">
                    @csrf

                    <div>
                        <label for="email" class="block text-sm font-medium text-zinc-900 mb-1.5">Alamat Email</label>
                        <div class="relative">
                            <i data-lucide="mail"
                    ...
                    <button type="submit"
                        class="w-full flex justify-center items-center gap-2 rounded-lg bg-zinc-900 px-4 py-3 text-sm font-bold text-white hover:bg-zinc-800 transition-all active:scale-[0.98] shadow-sm uppercase tracking-wide">
                        Masuk Sekarang
            ...
            <div class="bg-zinc-50 border-t border-zinc-100 p-4 text-center">
                <p class="text-xs text-zinc-500">
                    Belum punya akun? <a href="{{ route('candidate.register') }}" class="text-blue-600 font-bold hover:underline">Daftar sekarang</a>
                </p>
            </div>
        </div>
